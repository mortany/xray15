...
function SetupSymbols( )
{
	try
	{
		...
		// Paramblock enums
		var paramEnumsString = RenderToString("MASTER_PARAMBLOCKENUMS.txt");
		wizard.AddSymbol("TEMPLATESTRING_PARAMBLOCKENUMS", paramEnumsString);

		// Copyright notice
		var copyrightString = RenderToString("MASTER_COPYRIGHT.txt");
		wizard.AddSymbol("TEMPLATESTRING_COPYRIGHT", copyrightString);
		...
		// Symbols for Qt projects
		var qtLibs = "";
		var qtLib = "";
		var qtInclude = "";
		var qtDepends = "";
		useQt = wizard.FindSymbol("QT_UI");
		if (useQt){
			qtLibs = "QT_CORE_LIB; QT_GUI_LIB; QT_WIDGETS_LIB;";
			qtLib = "$(QTDIR)\\lib;";
			qtInclude = "$(QTDIR)\\include;$(QTDIR)\\include\\QtCore;$(QTDIR)\\include\\QtGui;$(QTDIR)\\include\\QtANGLE;$(QTDIR)\\include\\QtWidgets;.\\GeneratedFiles;";
			qtDepends = "Qt5Core.lib;Qt5Cored.lib;Qt5Gui.lib;Qt5Guid.lib;Qt5Widgets.lib;Qt5Widgetsd.lib;";
		}
		wizard.AddSymbol("QTLIBS", qtLibs);
		wizard.AddSymbol("QTLIB", qtLib);
		wizard.AddSymbol("QTINCLUDE", qtInclude);
		wizard.AddSymbol("QTDEPENDS", qtDepends);
	}
	catch(e)
	{
		throw e;
