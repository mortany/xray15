...
#define MAXVER_INTERNALNAME "PainterTextureSample\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "PainterTextureSample.dlt\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "3ds Max PainterTextureSample\0"//should  be overidden on a per-dll level
