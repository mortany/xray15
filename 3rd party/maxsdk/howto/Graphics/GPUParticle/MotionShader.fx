...
technique11 MotionShader
{
	pass P0
	{
		SetVertexShader(CompileShader(vs_5_0, Motion_vs_Main()));
        SetGeometryShader(ConstructGSWithSO(CompileShader(vs_5_0, Motion_vs_Main()), "0:Color.rgba;0:Position.xyz;", NULL, NULL, NULL, 0));
        SetPixelShader( NULL );
	}
}