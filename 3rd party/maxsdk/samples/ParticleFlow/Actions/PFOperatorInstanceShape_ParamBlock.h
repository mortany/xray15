...
enum {	kInstanceShape_sepGroup,
		...
		kInstanceShape_mtlIDOffset,
		kInstanceShape_reportNodeHandles,
		kInstanceShape_handlesToReport
};
...
enum {	kInstanceShape_reportNodeHandles_none,
		kInstanceShape_reportNodeHandles_selected,
		kInstanceShape_reportNodeHandles_all,
		kInstanceShape_reportNodeHandles_num };
...
private:
	...
	static void UpdateMtlIDOffsetDlg( HWND hWnd, BOOL acquireMtl);
};
