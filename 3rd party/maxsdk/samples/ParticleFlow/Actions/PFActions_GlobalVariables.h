...
// Visibility channels
	// viewport
#define PARTICLECHANNELVISIBILITYVPR_INTERFACE Interface_ID(0x27d60d2d, 0x1eb34500) 
#define PARTICLECHANNELVISIBILITYVPW_INTERFACE Interface_ID(0x27d60d2d, 0x1eb34501) 
#define GetParticleChannelVisibilityVPRInterface(obj) ((IParticleChannelBoolR*)obj->GetInterface(PARTICLECHANNELVISIBILITYVPR_INTERFACE)) 
#define GetParticleChannelVisibilityVPWInterface(obj) ((IParticleChannelBoolW*)obj->GetInterface(PARTICLECHANNELVISIBILITYVPW_INTERFACE)) 
	// render
#define PARTICLECHANNELVISIBILITYRNR_INTERFACE Interface_ID(0x27d60d2e, 0x1eb34500) 
#define PARTICLECHANNELVISIBILITYRNW_INTERFACE Interface_ID(0x27d60d2e, 0x1eb34501) 
#define GetParticleChannelVisibilityRNRInterface(obj) ((IParticleChannelBoolR*)obj->GetInterface(PARTICLECHANNELVISIBILITYRNR_INTERFACE)) 
#define GetParticleChannelVisibilityRNWInterface(obj) ((IParticleChannelBoolW*)obj->GetInterface(PARTICLECHANNELVISIBILITYRNW_INTERFACE)) 
	// by operator
#define PARTICLECHANNELVISIBILITYOPR_INTERFACE Interface_ID(0x27d60d2f, 0x1eb34500) 
#define PARTICLECHANNELVISIBILITYOPW_INTERFACE Interface_ID(0x27d60d2f, 0x1eb34501) 
#define GetParticleChannelVisibilityOPRInterface(obj) ((IParticleChannelBoolR*)obj->GetInterface(PARTICLECHANNELVISIBILITYOPR_INTERFACE)) 
#define GetParticleChannelVisibilityOPWInterface(obj) ((IParticleChannelBoolW*)obj->GetInterface(PARTICLECHANNELVISIBILITYOPW_INTERFACE)) 
