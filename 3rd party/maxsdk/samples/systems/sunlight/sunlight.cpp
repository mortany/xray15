...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("CityRestore"); } // from Animatable
...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("ManualRestore"); } // from Animatable
...
void SunMaster::SetCityInfo(const TCHAR* name, int& zone, float& lati, float& longi)
{
...
RefResult SunMaster::NotifyRefChanged(const Interval& changeInt, RefTargetHandle hTarget, 
