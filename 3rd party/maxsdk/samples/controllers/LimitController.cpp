...
void BaseLimitCtrl::GetClassName(TSTR& s) 
{
	s = GetString(IDS_BASELIMITCTRL_CLASS_NAME);
}

TSTR BaseLimitCtrl::SubAnimName(int i) 
{ 
	if (i == 0) 
...
void FloatLimitCtrl::GetClassName(TSTR& s) 
{
	s = GetString(IDS_FLOATLIMITCTRL_CLASS_NAME);
}
