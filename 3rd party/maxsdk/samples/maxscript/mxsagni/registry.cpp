...
HKeyClass::apply(Value** arg_list, int count,  CallContext* cc)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("HKey"));
...
registry_closeKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.closeKey"));
...
registry_flushKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.flushKey"));
...
registry_deleteSubKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.deleteSubKey"));
...
registry_deleteKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.deleteKey"));
...
registry_createKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.createKey"));
...
registry_openKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.openKey"));
...
registry_deleteValue_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.deleteValue"));
...
registry_setValue_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.setValue"));
...
registry_queryValue_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.queryValue"));
...
registry_queryInfoKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.queryInfoKey"));
...
registry_isKeyOpen_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.isKeyOpen"));
...
registry_isParentKeyOpen_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.isParentKeyOpen"));
...
registry_getParentKey_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getParentKey"));
...
registry_getSubKeyName_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getSubKeyName"));
...
registry_getSubKeyNames_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getSubKeyNames"));
...
registry_getValueName_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getValueName"));
...
registry_getValueNames_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getValueNames"));
...
registry_getLastError_cf(Value** arg_list, int count)
{
	...
	if (GetCOREInterface17()->InSecureMode())
		throw RuntimeError(MaxSDK::GetResourceStringAsMSTR(IDS_UNAVAIL_IN_SECURE_MODE), _T("registry.getLastError"));
