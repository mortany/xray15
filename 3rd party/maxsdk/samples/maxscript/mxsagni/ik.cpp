...
ik_getStartTime_cf (Value** arg_list, int count)
{
	...
	if (ref && ref->ClassID() == IKMASTER_CLASSID)
	{
		...
		return_value (MSTime::intern(themaster->GetStartTime()));
	}
	else
		return &undefined;
}
...
ik_getEndTime_cf (Value** arg_list, int count)
{
	...
	{
		IKMasterControl* themaster = (IKMasterControl*)ref;
		return_value (MSTime::intern(themaster->GetEndTime()));
	}
	else
		return &undefined;
...
ik_getIterations_cf (Value** arg_list, int count)
{
	...
	{
		IKMasterControl* themaster = (IKMasterControl*)ref;
		return_value (Integer::intern(themaster->GetIterations()));
	}
	else
		return &undefined;
}
...
ik_getPosThreshold_cf (Value** arg_list, int count)
{
	...
	{
		IKMasterControl* themaster = (IKMasterControl*)ref;
		return_value (Float::intern(themaster->GetPosThresh()));
	}
	else
		return &undefined;
}
...
ik_getRotThreshold_cf (Value** arg_list, int count)
{
	...
	{
		IKMasterControl* themaster = (IKMasterControl*)ref;
		return_value (Float::intern(RadToDeg(themaster->GetRotThresh())));
	}
	else
		return &undefined;
