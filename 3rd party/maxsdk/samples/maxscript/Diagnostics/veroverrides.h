...
#define MAXVER_INTERNALNAME "Maxscript Diagnostics\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Maxscript.Diagnostics.dlx\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Maxscript Diagnostics Utility\0"//should be overidden on a per-dll level
