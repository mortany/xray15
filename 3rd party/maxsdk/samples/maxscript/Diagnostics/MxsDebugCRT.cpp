...
Value* CRTCheckAssert_cf(Value** arg_list, int count)
{
	...
	case 2:
		...
		break;
	case 3:
		assert1(__LINE__,__FILE__,__FUNCTION__,"This will call the ascii version of the assert");
		break;
	case 4:
		assert1(__LINE__,__FILEW__,__FUNCTIONW__,L"This will call the Unicode version of the assert");
		break;
	default:
		return &false_value;
	}
