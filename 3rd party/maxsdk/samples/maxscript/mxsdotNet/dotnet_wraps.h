...
def_struct_primitive_debug_ok	( dotNet_loadIcon,		dotNet,	"loadIcon");
def_struct_primitive_debug_ok	( dotNet_DotNetObject_To_Value,		dotNet,	"DotNetObjectToValue");
def_struct_primitive_debug_ok	( dotNet_DotNetArray_To_Value, dotNet, "DotNetArrayToValue");
