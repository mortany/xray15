...
void CDotNetHostWnd::SetWidth(int width)
{
	System::Windows::Forms::Control ^ pControl = GetProxyType()->get_control();
	if (pControl)
...
void CDotNetHostWnd::SetHeight(int height)
{
	System::Windows::Forms::Control ^ pControl = GetProxyType()->get_control();
	if (pControl)
