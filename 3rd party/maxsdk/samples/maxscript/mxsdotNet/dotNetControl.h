...
visible_class_s (dotNetControl, RolloutControl)
...
protected:
	...
	LONG		m_AtomFlag; // used for ensuring only a single thread operating on m_pEventHandlers
public:
