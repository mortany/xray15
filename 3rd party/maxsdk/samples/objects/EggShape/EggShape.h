...
class EggAccessor : public PBAccessor, PBRescaleParamAccessor
{
	//void Get(PB2Value& v, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t, Interval &valid);
	void Set(PB2Value& v, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t);	// Regular accessor method
	void DeleteThis(){ delete this;}
	...
	void Set(PB2Value& v, float scaleFactor, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t);
};
