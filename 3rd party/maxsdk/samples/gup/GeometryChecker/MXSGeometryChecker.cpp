...
bool MXSGeometryChecker::IsSupported(INode * node)
{
	...
	{
		ProcessMAXScriptException(UnknownSystemException(), MaxSDK::GetResourceStringAsMSTR(IDS_REGISTER_EXCEPTION_SUPPORT), true, true, true);
	}
...
void MXSGeometryChecker::ShowPropertyDlg()
{
	...
	{
		ProcessMAXScriptException(UnknownSystemException(), MaxSDK::GetResourceStringAsMSTR(IDS_REGISTER_EXCEPTION_POPUP), true, true, true);
	}
...
MSTR MXSGeometryChecker::TextOverride()
{
	...
	{
		ProcessMAXScriptException(UnknownSystemException(), MaxSDK::GetResourceStringAsMSTR(IDS_REGISTER_EXCEPTION_TEXT), true, true, true);
	}
...
void MXSGeometryChecker::DisplayOverride(TimeValue t, INode* node, HWND hwnd,Tab<int> &results)
{
	...
	{
		ProcessMAXScriptException(UnknownSystemException(), MaxSDK::GetResourceStringAsMSTR(IDS_REGISTER_EXCEPTION_DISPLAY), true, true, true);
	}
