...
static ParamUIDesc descParam[] = {
	...
	// Fractal
	ParamUIDesc(PB_FRACT,TYPE_SINGLECHECKBOX,IDC_CELLTEX_FRACTAL),
	...
	// Use cell color map
	ParamUIDesc(PB_USECELLMAP,TYPE_SINGLECHECKBOX,IDC_CELLTEX_CELLCOLOR_USEMAP),

	// Use div1 color map
	ParamUIDesc(PB_USEDIV1MAP,TYPE_SINGLECHECKBOX,IDC_CELLTEX_DIVCOL1_USEMAP),

	// Use div2 color map
	ParamUIDesc(PB_USEDIV2MAP,TYPE_SINGLECHECKBOX,IDC_CELLTEX_DIVCOL2_USEMAP),
	...
	// adaptive
	ParamUIDesc(PB_ADAPT,TYPE_SINGLECHECKBOX,IDC_CELLTEX_ADAPTIVE),
	};
*/
