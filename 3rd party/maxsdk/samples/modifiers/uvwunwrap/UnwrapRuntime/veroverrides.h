...
#define MAXVER_INTERNALNAME "UnwrapRuntime\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "UnwrapRuntime.exe\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Unwrap Runtime (exe)\0"//should  be overidden on a per-dll level
