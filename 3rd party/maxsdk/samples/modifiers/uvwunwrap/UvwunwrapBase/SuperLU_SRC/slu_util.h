 ...
 *        refinement.
 */
typedef UNWRAP_BASE_EXPORT struct {
    fact_t        Fact;
    yes_no_t      Equil;
    colperm_t     ColPerm;
    trans_t       Trans;
...
extern UNWRAP_BASE_EXPORT void    Destroy_SuperMatrix_Store(SuperMatrix *);
extern UNWRAP_BASE_EXPORT void    Destroy_CompCol_Matrix(SuperMatrix *);
extern void    Destroy_CompRow_Matrix(SuperMatrix *);
extern UNWRAP_BASE_EXPORT void    Destroy_SuperNode_Matrix(SuperMatrix *);
extern void    Destroy_CompCol_Permuted(SuperMatrix *);
extern void    Destroy_Dense_Matrix(SuperMatrix *);
extern UNWRAP_BASE_EXPORT void    get_perm_c(int, SuperMatrix *, int *);
extern void    set_default_options(superlu_options_t *options);
extern UNWRAP_BASE_EXPORT void    sp_preorder (superlu_options_t *, SuperMatrix*, int*, int*,
			    SuperMatrix*);
...
extern UNWRAP_BASE_EXPORT int     sp_ienv (int);
extern int     lsame_ (char *, char *);
extern UNWRAP_BASE_EXPORT int     xerbla_ (char *, int *);
extern void    ifill (int *, int, int);
extern void    snode_profile (int, int *);
extern void    super_stats (int, int *);
extern void    PrintSumm (char *, int, int, int);
extern UNWRAP_BASE_EXPORT void    StatInit(SuperLUStat_t *);
extern UNWRAP_BASE_EXPORT void    StatPrint (SuperLUStat_t *);
extern UNWRAP_BASE_EXPORT void    StatFree(SuperLUStat_t *);
