...
extern UNWRAP_BASE_EXPORT void
...
extern UNWRAP_BASE_EXPORT void    sgstrf (superlu_options_t*, SuperMatrix*, float,
...
extern void    sFillRHS (trans_t, int, float *, int, SuperMatrix *,
			  SuperMatrix *);
extern UNWRAP_BASE_EXPORT void   sgstrs (trans_t, SuperMatrix *, SuperMatrix *, int *, int *,
