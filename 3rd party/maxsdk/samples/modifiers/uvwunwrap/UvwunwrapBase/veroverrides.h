...
#define MAXVER_INTERNALNAME "UnwrapBase.dll\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "UnwrapBase.dll\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "UnwrapBase Dll\0"//should  be overidden on a per-dll level
