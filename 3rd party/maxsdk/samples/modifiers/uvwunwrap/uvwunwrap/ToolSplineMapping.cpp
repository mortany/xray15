...
SplineElementData::SplineElementData() : mCurves(0)
{
	mIsClosed = false;
	mIsSelected = false;
...
SplineElementData::SplineElementData( SplineElementData *splineData) : mPlanarMapUp(0), mLine(NULL), 
	mSplineLength(0.0f), mAdvanceSplines(0), mCurves(0)
{
