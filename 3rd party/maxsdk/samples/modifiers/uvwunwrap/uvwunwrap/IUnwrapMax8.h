...
//2009 exposure
		...
		unwrap_paintview,
		unwrap_get_mirror_selection_status,
		unwrap_set_mirror_selection_status,
		unwrap_get_mirror_axis,
		unwrap_set_mirror_axis,
		unwrap_get_mirror_threshold,
		unwrap_set_mirror_threshold,

		unwrap_get_selection_preview, 
		unwrap_set_selection_preview,

		unwrap_get_paint_move_brush,
		unwrap_set_paint_move_brush,
		unwrap_get_relax_move_brush,
		unwrap_set_relax_move_brush,
		unwrap_get_paint_full_strength_size,
		unwrap_set_paint_full_strength_size,
		unwrap_get_paint_fall_off_size,
		unwrap_set_paint_fall_off_size,
		unwrap_get_paint_falloff_type,
		unwrap_set_paint_falloff_type,

		unwrap_close_editor,
		unwrap_close_options,
		unwrap_relaxthreaded,

		unwrap_set_typein_linkUV,
		unwrap_get_typein_linkUV,

		unwrap_set_nonsquare_apply_bitmap_ratio,
		unwrap_get_nonsquare_apply_bitmap_ratio,

		unwrap_get_editor_hwnd,
		unwrap_get_editor_view_hwnd,

		unwrap_get_tile_grid_visible,
		unwrap_set_tile_grid_visible,

// pixel units display
		unwrap_get_display_pixel_units,
		unwrap_set_display_pixel_units
};
...
enum
{
	...
	mirror_axis_enum,
	paint_falloff_type_enum,
	relax_threaded_enum
};

enum PaintFallOffOptions
{
	paint_falloff_linear,
	paint_falloff_smooth,
	paint_falloff_slow,
	paint_falloff_fast,
};
...
enum RelaxBrushType
{
	relax_by_polygon_angles,
	relax_by_edge_angles,
	relax_by_center,
};

enum MirrorAxisOptions
{
	mirror_by_x_axis = 0,
	mirror_by_y_axis,
	mirror_by_z_axis,
...
class IUnwrapMod5 : public FPMixinInterface  //interface for R8
	...
	public:
		...
		BEGIN_FUNCTION_MAP
			...
			VFN_2(unwrap_setwindowxoffset, fnSetWindowXOffset,TYPE_INT, TYPE_bool);
			VFN_2(unwrap_setwindowyoffset, fnSetWindowYOffset,TYPE_INT, TYPE_bool);
			...
			VFN_3(unwrap_renderuv, fnRenderUV, TYPE_FILENAME, TYPE_INT, TYPE_INT);
		...
		virtual void fnSetWindowXOffset(int offset, bool applyUIScaling = false) = 0;
		virtual void fnSetWindowYOffset(int offset, bool applyUIScaling = false) = 0;
		...
		virtual void fnRenderUV(const MCHAR *name, int UTile, int VTile) = 0;
...
class IUnwrapMod6 : public FPMixinInterface  //interface for R10 && R11 && Kirin
	{
	public:
		...
		BEGIN_FUNCTION_MAP
			...
			VFN_3(unwrap_sketchByNode, fnSketchByNode,TYPE_INT_TAB,TYPE_POINT3_TAB,TYPE_INODE);
			...
			FN_2(unwrap_splinemap_getCrossSection_Pos, TYPE_POINT3_BV, fnSplineMap_GetCrossSection_Pos,TYPE_INDEX,TYPE_INDEX);
			...
			FN_2(unwrap_splinemap_getCrossSection_Twist, TYPE_QUAT_BV, fnSplineMap_GetCrossSection_Twist,TYPE_INDEX,TYPE_INDEX);
			...
			VFN_0(unwrap_alignbypivot_horizontal, fnAlignByPivotHorizontal);
			VFN_0(unwrap_alignbypivot_vertical, fnAlignByPivotVertical);

			VFN_0(unwrap_paintview, fnPaintView);

			VFN_0(unwrap_close_editor, fnCloseEditor);
			VFN_0(unwrap_close_options, fnCloseOptions);

			VFN_1(unwrap_relaxthreaded, fnRelaxThreaded, TYPE_ENUM);

			PROP_FNS(unwrap_get_mirror_selection_status, fnGetMirrorSelectionStatus, unwrap_set_mirror_selection_status, fnSetMirrorSelectionStatus, TYPE_BOOL);
			PROP_FNS(unwrap_get_mirror_axis, fnGetMirrorAxis, unwrap_set_mirror_axis, fnSetMirrorAxis, TYPE_ENUM);
			PROP_FNS(unwrap_get_mirror_threshold, fnGetMirrorThreshold, unwrap_set_mirror_threshold, fnSetMirrorThreshold, TYPE_FLOAT);
			PROP_FNS(unwrap_get_selection_preview, fnGetSelectionPreview, unwrap_set_selection_preview, fnSetSelectionPreview, TYPE_bool);

			PROP_FNS(unwrap_get_paint_move_brush, fnGetPaintMoveBrush, unwrap_set_paint_move_brush, fnSetPaintMoveBrush, TYPE_bool);
			PROP_FNS(unwrap_get_relax_move_brush, fnGetRelaxMoveBrush, unwrap_set_relax_move_brush, fnSetRelaxMoveBrush, TYPE_bool);
			PROP_FNS(unwrap_get_paint_full_strength_size, fnGetPaintFullStrengthSize, unwrap_set_paint_full_strength_size, fnSetPaintFullStrengthSize, TYPE_FLOAT);
			PROP_FNS(unwrap_get_paint_fall_off_size, fnGetPaintFallOffSize, unwrap_set_paint_fall_off_size, fnSetPaintFallOffSize, TYPE_FLOAT);
			PROP_FNS(unwrap_get_paint_falloff_type, fnGetPaintFallOffType, unwrap_set_paint_falloff_type, fnSetPaintFallOffType, TYPE_ENUM);
			PROP_FNS(unwrap_get_typein_linkUV, fnGetTypeInLinkUV, unwrap_set_typein_linkUV, fnSetTypeInLinkUV, TYPE_bool);
			PROP_FNS(unwrap_get_nonsquare_apply_bitmap_ratio, fnGetNonSquareApplyBitmapRatio, unwrap_set_nonsquare_apply_bitmap_ratio, fnSetNonSquareApplyBitmapRatio, TYPE_BOOL);
			RO_PROP_FN(unwrap_get_editor_hwnd, fnGetEditorHWND, TYPE_HWND);
			RO_PROP_FN(unwrap_get_editor_view_hwnd, fnGetEditorViewHWND, TYPE_HWND);
			PROP_FNS(unwrap_get_tile_grid_visible, fnGetTileGridVisible, unwrap_set_tile_grid_visible, fnSetTileGridVisible, TYPE_BOOL );
			PROP_FNS(unwrap_get_display_pixel_units, fnGetDisplayPixelUnits, unwrap_set_display_pixel_units, fnSetDisplayPixelUnits, TYPE_BOOL);
		...
		virtual void  fnSketchByNode(Tab<int> *indexList,Tab<Point3*> *positionList,INode *node) = 0;
...
//R11 function that mainly deal with spline mapping
		...
		/* threadOp = 1 start, threadOp = 2 restart, threadOp = 3 end*/
		virtual	void	fnRelaxThreaded(int threadOp) = 0;
		...
		virtual float fnGroupGetTexelDensity() = 0;
		 ...
		 virtual void fnPaintView() = 0;

		 virtual void fnCloseEditor() = 0;
		 virtual void fnCloseOptions() = 0;

		 virtual BOOL fnGetMirrorSelectionStatus() = 0;
		 virtual void fnSetMirrorSelectionStatus(BOOL) = 0;

		 virtual int fnGetMirrorAxis() = 0;
		 virtual void fnSetMirrorAxis(int) = 0;

		 virtual float fnGetMirrorThreshold() = 0;
		 virtual void fnSetMirrorThreshold(float) = 0;

		 virtual bool fnGetSelectionPreview() const = 0;
		 virtual void fnSetSelectionPreview(bool) = 0;

		 virtual void fnSetPaintMoveBrush(bool) = 0;
		 virtual bool fnGetPaintMoveBrush() const = 0;

		 virtual void fnSetRelaxMoveBrush(bool) = 0;
		 virtual bool fnGetRelaxMoveBrush() const = 0;

		 virtual void fnSetPaintFullStrengthSize(float) = 0;
		 virtual float fnGetPaintFullStrengthSize() const = 0;

		 virtual void fnSetPaintFallOffSize(float) = 0;
		 virtual float fnGetPaintFallOffSize() const = 0;

		 virtual void fnSetPaintFallOffType(int) = 0;
		 virtual int fnGetPaintFallOffType() const = 0;

		 virtual void fnSetTypeInLinkUV(bool newVal) = 0;
		 virtual bool fnGetTypeInLinkUV() const = 0;

		 virtual void fnSetNonSquareApplyBitmapRatio(BOOL bApplyRatio) = 0;
		 virtual BOOL fnGetNonSquareApplyBitmapRatio() const = 0;

		 virtual HWND fnGetEditorHWND() const = 0;
		 virtual HWND fnGetEditorViewHWND() const = 0;

		 virtual BOOL fnGetTileGridVisible() const = 0;
		 virtual void fnSetTileGridVisible( BOOL bVisible ) = 0;

		 virtual void fnSetDisplayPixelUnits(BOOL bDisplayPixelUnits) = 0;
		 virtual BOOL fnGetDisplayPixelUnits() const = 0;
};
