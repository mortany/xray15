...
static FPInterfaceDesc meshdeformpw_interface(MESHDEFORMPW_INTERFACE, _T("meshDeformOps"), 0, &MeshDeformPWDesc,
	...
	meshdeform_getselectedvertices, _T("getSelectedVertices"), 0, TYPE_BITARRAY, 0, 1, _T("wrapNodeIndex"), 0,
	TYPE_INDEX, meshdeform_setselectedvertices, _T("setSelectVertices"), 0, TYPE_VOID, 0, 3, _T("wrapNodeIndex"), 0,
	TYPE_INDEX, _T("sel"), 0, TYPE_BITARRAY, _T("update"), 0, TYPE_BOOL,

	meshdeform_getnumbercontrolpoints, _T("getNumberOfControlPoints"), 0, TYPE_INT, 0, 1, _T("wrapNodeIndex"), 0,
	TYPE_INDEX,

	meshdeform_getcontrolpointscale, _T("getControlPointScale"), 0, TYPE_POINT3, 0, 2, _T("wrapNodeIndex"), 0,
	TYPE_INDEX, _T("index"), 0, TYPE_INDEX, meshdeform_setcontrolpointscale, _T("setControlPointScale"), 0, TYPE_VOID,
	0, 3, _T("wrapNodeIndex"), 0, TYPE_INDEX, _T("index"), 0, TYPE_INDEX, _T("scale"), 0, TYPE_POINT3,

	meshdeform_getcontrolpointstr, _T("getControlPointStr"), 0, TYPE_FLOAT, 0, 2, _T("wrapNodeIndex"), 0, TYPE_INDEX,
	_T("index"), 0, TYPE_INDEX, meshdeform_setcontrolpointstr, _T("setControlPointStr"), 0, TYPE_VOID, 0, 3,
	_T("wrapNodeIndex"), 0, TYPE_INDEX, _T("index"), 0, TYPE_INDEX, _T("str"), 0, TYPE_FLOAT,

	meshdeform_mirrorselectedcontrolpoints, _T("mirrorSelectedControlPoints"), 0, TYPE_VOID, 0, 0,
	meshdeform_bakecontrolpoints, _T("bakeControlPoint"), 0, TYPE_VOID, 0, 0, meshdeform_retrievecontrolpoints,
	_T("retrieveControlPoint"), 0, TYPE_VOID, 0, 0, meshdeform_resample, _T("reset"), 0, TYPE_VOID, 0, 0,

	meshdeform_setlocalscale, _T("setLocalScale"), 0, TYPE_VOID, 0, 2, _T("axis"), 0, TYPE_INDEX, _T("scale"), 0,
	TYPE_FLOAT, meshdeform_setlocalstr, _T("setLocalStr"), 0, TYPE_VOID, 0, 1, _T("str"), 0, TYPE_FLOAT,

	meshdeform_getcontrolpointinitialtm, _T("getControlPointInitialTM"), 0, TYPE_MATRIX3, 0, 2, _T("wrapNodeIndex"), 0,
	TYPE_INDEX, _T("index"), 0, TYPE_INDEX, meshdeform_getcontrolpointcurrenttm, _T("getControlPointCurrentTM"), 0,
	TYPE_MATRIX3, 0, 2, _T("wrapNodeIndex"), 0, TYPE_INDEX, _T("index"), 0, TYPE_INDEX, meshdeform_getcontrolpointdist,
	_T("getControlPointDist"), 0, TYPE_FLOAT, 0, 2, _T("wrapNodeIndex"), 0, TYPE_INDEX, _T("index"), 0, TYPE_INDEX,
	meshdeform_getcontrolpointxvert, _T("getControlPointXVert"), 0, TYPE_INT, 0, 2, _T("wrapNodeIndex"), 0, TYPE_INDEX,
	_T("index"), 0, TYPE_INDEX,

	meshdeform_converttoskin, _T("ConvertToSkin"), 0, TYPE_VOID, 0, 1, _T("silent"), 0, TYPE_BOOL,
	...
	const Matrix3& meshTM, const Matrix3& baseTM, const Matrix3& initialBaseTM)
{
	...
	tbb::parallel_for(
		tbb::blocked_range<int>(0, msh->numVerts, ThreadTools::TbbGrainsize(msh->numVerts)), [&](const auto& range) {
...
void MeshDeformPW::BuildNormals(Mesh* mesh, Tab<Point3>& vnorms, Tab<Point3>& fnorms)
{
	...
	tbb::parallel_for(
		tbb::blocked_range<int>(0, mesh->numFaces, ThreadTools::TbbGrainsize(mesh->numFaces)), [&](const auto& range) {
	...
	tbb::parallel_for(
		tbb::blocked_range<int>(0, mesh->numVerts, ThreadTools::TbbGrainsize(mesh->numVerts)), [&](const auto& range) {
			Point3 zero{};
			for (int j = range.begin(); j < range.end(); ++j)
			{
				if (vnormsPtr[j] == zero)
