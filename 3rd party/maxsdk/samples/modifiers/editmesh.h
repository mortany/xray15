...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerMeshMNode"); } // from Animatable
};
...
public:	
	...
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerMeshMMtl"); } // from Animatable
};
