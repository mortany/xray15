...
//fillout the combo boxes and set default
			...
			{
				ShowWindow(GetDlgItem(hWnd,IDC_VOXEL_COMBO),SW_HIDE);
				ShowWindow(GetDlgItem(hWnd,IDC_WEIGHT_SOLVER),SW_HIDE);
				ShowWindow(GetDlgItem(hWnd,IDC_STATIC_WEIGHT_TEXT),SW_HIDE);

				int offset = 20;
				MoveWindowUp(GetDlgItem(hWnd,IDC_ENVELOPE_STATIC), 0, offset);
				int boffset = 20;
				MoveWindowUp(GetDlgItem(hWnd,IDC_BONE_TOOLBAR), -10, 0);
				
				int woffset = -20;
				MoveWindowUp(GetDlgItem(hWnd,IDC_STATIC_WEIGHTPROP), woffset, woffset);
				int aoffset = 25;
				MoveWindowUp(GetDlgItem(hWnd,IDC_ABS_STATIC), aoffset, 0);
				MoveWindowUp(GetDlgItem(hWnd,IDC_EFFECT), aoffset, 0);
				MoveWindowUp(GetDlgItem(hWnd,IDC_EFFECTSPIN), aoffset, 0);
