...
protected:
    ...
    enum PolyOperationVersionType {POLYOP_ORIGINAL = 0, POLYOP_2018_4 = 1, POLYOP_2018_5 = 2, POLYOP_2019_1 = 3, POLYOP_2020 = 4};
...
private:
	...
	//if we a previewing a loop with the shift key
	bool mInPreviewLoop;
...
public:
	...
	MNMesh		mShiftSelMesh;  // a copy of the mesh used for shift sel since the cache meshes can be null in some case
};
...
private:
	...
	void Drag (TimeValue t, float , int segments, float tension);
