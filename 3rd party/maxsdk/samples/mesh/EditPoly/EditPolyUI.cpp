...
class EditPolyModPBAccessor : public PBAccessor {
	...
	void Set(PB2Value& v, ReferenceMaker* owner, ParamID id, int tabIndex, TimeValue t)
		{ 
			...
			if ((id == epm_debug_last_delta) && mpEditPolyMod)
			{
				ModContextList list;
				INodeTab nodes;
...
static ParamBlockDesc2 edit_mod_param_blk (kEditPolyParams, _T("Edit Poly Parameters"), 0, &emodDesc,
	...
	p_default, FALSE,
	p_ui, ep_settings, TYPE_SINGLECHECKBOX, IDC_CHAMFER_VERTEX_OPEN,
	p_end,
	...
	epm_edge_chamfer_type, _T("edgeChamferType"), TYPE_INT, P_TRANSIENT, IDS_EDGE_CHAMFER_TYPE,
	...
	epm_edge_chamfer_quad_intersections, _T("edgeChamferQuadIntersections"), TYPE_BOOL, P_TRANSIENT, IDS_EDGE_CHAMFER_QUAD_INTERSECTIONS,
	p_default, FALSE,
