...
class EditPolyObject : public PolyObject, public EventUser, public ISubMtlAPI,
			public EPoly18, public AttachMatDlgUser, public IMeshSelect,
...
public:
	...
	void 	EpfnDragChamfer (float amount, float tension, TimeValue t);
...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerPolyMtl"); } // from Animatable
};
...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerPolyNode"); } // from Animatable
};
