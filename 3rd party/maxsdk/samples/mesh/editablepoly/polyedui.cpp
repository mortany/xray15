...
static ParamBlockDesc2 ep_param_block ( ep_block, _T("ePolyParameters"),
	...
	ep_ignore_backfacing, _T("ignoreBackfacing"), TYPE_BOOL, P_TRANSIENT, IDS_IGNORE_BACKFACING,
		p_default, FALSE,
		p_ui, ep_select, TYPE_SINGLECHECKBOX, IDC_IGNORE_BACKFACES,
		p_end,
	...
	ep_vertex_chamfer_open, _T("vertexChamferOpen"), TYPE_BOOL, P_TRANSIENT, IDS_OPEN_CHAMFER,
		p_default, FALSE,
		p_ui, ep_settings, TYPE_SINGLECHECKBOX, IDC_VERTEX_CHAMFER_OPEN,
		p_end,

	ep_edge_chamfer_open, _T("edgeChamferOpen"), TYPE_BOOL, P_TRANSIENT, IDS_OPEN_CHAMFER,
		p_default, FALSE,
		p_ui, ep_settings, TYPE_SINGLECHECKBOX, IDC_EDGE_CHAMFER_OPEN,
		p_end,
	...
	ep_edge_chamfer_type, _T("edgeChamferType"),TYPE_INT,0, IDS_EDGE_CHAMFER_TYPE,
		p_default, EP_STANDARD_EDGE_CHAMFER,	// Defaults to standard chamfer
		p_range, EP_STANDARD_EDGE_CHAMFER, EP_QUAD_EDGE_CHAMFER,
		p_ui, ep_settings, TYPE_RADIO, 2, IDC_CHAMFER_STANDARD, IDC_CHAMFER_QUAD,
		p_end,
	...
	ep_edge_chamfer_tension, _T("edgeChamferTension"), TYPE_FLOAT, P_TRANSIENT, IDS_EDGE_CHAMFER_TENSION,
		...
		p_range, 0.0f, 1.0f,
		p_ui, ep_settings, TYPE_SPINNER, EDITTYPE_POS_FLOAT,
			IDC_EDGE_CHAMFER_TENSION, IDC_EDGE_CHAMFER_TENSION_SPIN, SPIN_AUTOSCALE,
		p_end,

	ep_edge_chamfer_invert, _T("edgeChamferInvert"), TYPE_BOOL, P_TRANSIENT, IDS_EDGE_CHAMFER_INVERT,
		p_default, FALSE,
		p_ui, ep_settings, TYPE_SINGLECHECKBOX, IDC_EDGE_CHAMFER_INVERT,
		p_end,
	...
	ep_edge_chamfer_smooth_type, _T("edgeChamferSmoothType"),TYPE_INT, P_TRANSIENT, IDS_EDGE_CHAMFER_SMOOTH_TYPE,
		p_default, EP_EDGE_CHAMFER_SMOOTH_ALL,	// Defaults to smooth all
	...
	ep_edge_chamfer_smooth_threshold, _T("edgeChamferSmoothThreshold"), TYPE_FLOAT, P_TRANSIENT, IDS_EDGE_CHAMFER_SMOOTH_THRESHOLD,
		...
		p_range, 0.0f, 180.0f,
		p_ui, ep_settings, TYPE_SPINNER, EDITTYPE_POS_FLOAT,
			IDC_EDGE_CHAMFER_THRESHOLD, IDC_EDGE_CHAMFER_THRESHOLD_SPIN, SPIN_AUTOSCALE,
		p_end,
	...
	ep_edge_chamfer_quad_intersections, _T("edgeChamferQuadIntersections"), TYPE_BOOL, P_TRANSIENT, IDS_EDGE_CHAMFER_QUAD_INTERSECTIONS,
		p_default, TRUE,	// Defaults to quad version
		p_ui, ep_settings, TYPE_SINGLECHECKBOX, IDC_EDGE_CHAMFER_QUAD_INTERSECTIONS,
		p_end,
...
void PopupDlgProc::MaybeEnableControls(HWND hWnd, TimeValue t) {
	...
	if (GetDlgItem (hWnd, IDC_EDGE_CHAMFER_INVERT)) {
		...
		mpEPoly->getParamBlock()->GetValue (ep_edge_chamfer_type, t, mode, FOREVER);
		mpEPoly->getParamBlock()->GetValue (ep_edge_chamfer_open, t, open, FOREVER);
		mpEPoly->getParamBlock()->GetValue (ep_edge_chamfer_smooth, t, smooth, FOREVER);
...
bool EditPolyObject::ManipGripIsValid()
{
	...
	{
		if( GetManipulateGrip( EPoly13::eVertexCrease) ||
			GetManipulateGrip( EPoly13::eVertexWeight) )
		{
			if( GetManipulateGrip(  EPoly13::eSoftSelFalloff) ||  
				GetManipulateGrip(  EPoly13::eSoftSelBubble) ||
				GetManipulateGrip(  EPoly13::eSoftSelPinch))
...
void EditPolyObject::SetUpManipGripVisibility()
{
	...
	{
		BitArray copy;
		copy.SetSize((int) EPoly13::EPolyManipulatorGripCount);
		...
		copy.Set((int) EPoly13::eVertexCrease , GetManipulateGrip(EPoly13::eVertexCrease)) ;
		...
		{
			copy.Clear((int) EPoly13::eVertexCrease);
